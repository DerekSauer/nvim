...
if loaded then
    ...
    vim.keymap.set('n', "<leader>fm", function() require("telescope.builtin").man_pages() end,
    ...
    vim.keymap.set('n', "<leader>fl", function() require("telescope.builtin").loclist() end,
        { silent = true, desc = "Location list" })
    vim.keymap.set('n', "<leader>f/", function() require("telescope.builtin").keymaps() end,
